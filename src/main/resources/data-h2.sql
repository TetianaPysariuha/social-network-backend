...
VALUES
    ...
    (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Alice', 'Alice', 'image2.jpg', 2,1),
    (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Bob', 'Bob', 'image3.jpg', 3,3),
    (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Emma', 'Emma', 'image4.jpg', 4,5),
    (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'David', 'David', 'image5.jpg', 5,4);
...
INSERT INTO public.likes (user_id, post_id, created_date, updated_date)
VALUES
    (1,1, '2023-06-25 10:00:00', '2023-06-25 10:00:00'),
    (3,1, '2023-06-25 10:00:00', '2023-06-25 10:00:00'),
    (2,3, '2023-06-25 10:00:00', '2023-06-25 10:00:00'),
    (2,1, '2023-06-25 10:00:00', '2023-06-25 10:00:00'),
    (2,2, '2023-06-25 10:00:00', '2023-06-25 10:00:00'),
    (1,2, '2023-06-25 10:00:00', '2023-06-25 10:00:00');

INSERT INTO public.reposts (user_id, post_id, created_date, updated_date)
VALUES
    (1,1, '2023-06-25 10:00:00', '2023-06-25 10:00:00'),
    (3,1, '2023-06-25 10:00:00', '2023-06-25 10:00:00'),
    (2,3, '2023-06-25 10:00:00', '2023-06-25 10:00:00'),
