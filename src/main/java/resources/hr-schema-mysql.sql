...
ALTER TABLE TEmployees ADD FOREIGN KEY (job_id) REFERENCES jobs(job_id);
ALTER TABLE TEmployees ADD FOREIGN KEY (department_id) REFERENCES departments(department_id);
ALTER TABLE TEmployees ADD FOREIGN KEY (manager_id) REFERENCES TEmployees(employee_id);
ALTER TABLE departments ADD FOREIGN KEY (manager_id) REFERENCES TEmployees (employee_id);
ALTER TABLE job_history ADD FOREIGN KEY (employee_id) REFERENCES TEmployees(employee_id);
