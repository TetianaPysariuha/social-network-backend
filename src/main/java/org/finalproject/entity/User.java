...
public class User extends BaseEntity {
    ...
    },fetch = FetchType.EAGER ,mappedBy = "user",orphanRemoval = false)
    @LazyCollection(LazyCollectionOption.FALSE)
    @JsonIgnore
    List<Friend> users;

    @OneToMany (cascade = {CascadeType.MERGE,CascadeType.REMOVE},fetch = FetchType.EAGER ,mappedBy = "friend",orphanRemoval = false)
    @LazyCollection(LazyCollectionOption.FALSE)
    @JsonIgnore
    List<Friend> friends;
    ...
    @LazyCollection(LazyCollectionOption.FALSE)
    @JsonIgnore
    private List<Repost> repostedPosts;
